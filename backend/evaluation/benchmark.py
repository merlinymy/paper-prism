...
def run_ablation_study(
    ...
    configs = [
        ...
        {
            "name": "no_rewriting",
            "description": "Query rewriting disabled — no spelling correction",
            "kwargs": {
                "enable_classification": True,
                "enable_expansion": True,
                "enable_hyde": False,
        ...
        },
        {
            ...
            "description": "Minimal — embed, search, generate (no classification, expansion, entities, rewriting, hybrid)",
            "kwargs": {
                "enable_classification": False,
                "enable_expansion": False,
                "enable_hyde": False,
